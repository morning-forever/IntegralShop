...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		<div class="table-header">货运单号填写</div>
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form id="myform" class="form-horizontal" method="post" >
				<input type="hidden"  name="id" value="${id}">
				<div class="control-group">
					<label class="control-label" for="name"><span class="red f12">* </span>货运单号:</label>
					<div class="controls">
						<div class="span12">
							<input type="text" id="name" name="waybillNumber"  style="width: 300px;"/>
						</div>
					</div>
				</div>
		  	</form>
...
<script type="text/javascript">
	...
	function save(){
			...
			$.post('admin/integralShop/exchange_manage/saveWayBillNo', formObj , function(res) {
	...
	//返回
	function back(){
		location.href = "admin/integralShop/exchange_manage/main";
	}
	//表单序列化
