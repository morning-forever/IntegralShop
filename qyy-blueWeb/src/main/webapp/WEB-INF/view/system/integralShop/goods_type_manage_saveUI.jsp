...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		<div class="table-header">新增商品类型</div>
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form id="form" class="form-horizontal" method="post" >
				<div class="control-group">
					...
					<div class="controls">
						<div class="span12">
							<input type="text" id="name" name="goodsType"  style="width: 300px;"/>
						</div>
					</div>
				</div>
		  	</form>
...
function save(){
		...
		$.post('admin/integralShop/goods_type_manage/save', formObj , function(res) {
