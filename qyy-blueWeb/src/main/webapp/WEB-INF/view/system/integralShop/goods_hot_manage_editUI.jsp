...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		<div class="table-header">编辑商品热度</div>
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form id="form" class="form-horizontal" method="post" >
				<div class="control-group">
					<label class="control-label" for="name"><span class="red f12">* </span>商品热度名称:</label>
					<div class="controls">
						<div class="span12">
							<input type="hidden" name="id" value="${hotLevel.id }"/>
							<input type="text" id="name" name="level"  style="width: 300px;" value="${hotLevel.level }"/>
						</div>
					</div>
				</div>
		  	</form>
...
function save(){
		...
		$.post('admin/integralShop/goods_hot_manage/update', formObj , function(res) {
...
//返回
function back(){
	location.href = "admin/integralShop/goods_hot_manage/main";
}
//表单序列化
