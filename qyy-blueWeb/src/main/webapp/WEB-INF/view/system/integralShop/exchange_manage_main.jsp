				...
				<div class="tab-content">
					<table style="margin-left: 5px;" id="btnmenu">
						<tbody>
							...
							<tr>
								<td colspan="5"><a title="新增" href="javascript:void(0)" target="mainFrame"
...
<script type="text/javascript">
	...
	function initMainList(){
		$('#table_report').DataTable( {
			...
			"paging":true,
	        "ajax": {
	        	url:"admin/integralShop/exchange_manage/list",	
	        	type: "POST"
	        },
			"columns": [
	            { "data": null },//序号
	      ...
	      "columnDefs": [
				...
				},
				{
					...
					render: function (data, type, row) {
		                return "<img src="+data[0].imgUrl+" width='50' height='50'>";
					}
				},
				{
					"targets":8,
				...
				},
				{
					...
					render: function (data, type, row) {
						if(data==null){
							return "<a href='admin/integralShop/exchange_manage/waybillNumberEditUI/"+row.id+"'>填写货运单号</a>"
						}else{
							return data;
						}
					}
