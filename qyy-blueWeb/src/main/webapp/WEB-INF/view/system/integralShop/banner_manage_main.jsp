...
<body>
	<div class="container-fluid" id="main-container">
		...
		<!--#breadcrumbs-->
		<div class="row-fluid">
			<div class="table-header">横幅管理</div>
				<div class="tab-content">
					<table style="margin-left: 5px;" id="btnmenu">
						<tbody>
							<tr>
								<td colspan="5"><a title="新增" href="admin/integralShop/banner_manage/saveUI" target="mainFrame"
...
<script type="text/javascript">
	...
	function initMainList(){
		...
		$('#table_report').DataTable( {
			"bDestroy": true,
	        "ajax": {
	        	url:"admin/integralShop/banner_manage/list",	
	        	type: "POST"
	        },
			"columns": [
	            { "data": null },//序号
	        ...
	        "columnDefs": [
				...
				},
				{
	 	            "targets": 3,
	 	            render: function (a, b, c, d) {
 	            		context = {func: [{"name": "删除", "fn": "doDelete(\'" + c.id + "\')", "type": "danger", "icon":"trash"}]};
	...
	function doDelete(id){
		bootbox.confirm("确定要删除吗?", function(result) {
			if (result) {
				$.ajax({
					url : "admin/integralShop/banner_manage/delete/"+id,
					post : "post",
