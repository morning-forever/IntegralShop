...
<body>
	<div class="container-fluid" id="main-container">
		...
		<!--#breadcrumbs-->
		<div class="row-fluid">
			<div class="table-header">商品类型管理</div>
				<div class="tab-content">
					<table style="margin-left: 5px;" id="btnmenu">
						<tbody>
							<tr>
								<td colspan="5"><a title="新增" href="admin/integralShop/goods_type_manage/saveUI" target="mainFrame"
...
<script type="text/javascript">
	...
	function initMainList(){
		...
		$('#table_report').DataTable( {
			"bDestroy": true,
	        "ajax": {
	        	url:"admin/integralShop/goods_type_manage/list",	
	        	type: "POST"
	        },
			"columns": [
	            { "data": null },//序号
	            { "data": "goods_type" },//商品类型
	            { "data": null }//操作
	        ],
	        "columnDefs": [
				{
	...
	//编辑
	function doEdit(id){
		location.href = "admin/integralShop/goods_type_manage/editUI/"+id;
	}
	...
	function doDelete(id){
		bootbox.confirm("确定要删除吗?", function(result) {
			if (result) {
				$.ajax({
					url : "admin/integralShop/goods_type_manage/delete/"+id,
					post : "post",
