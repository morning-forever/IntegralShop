...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<!--#breadcrumbs-->
		<div class="row-fluid">
			<div class="table-header">餐饮信息</div>
				...
				<div class="tab-pane active" id="tab_1">
					<table class="mytable-detail">
						<tbody>
							...
							<tr>
								<th>套餐：</th>
								<td>${goodsCater.meal }</td>
							</tr>
							<tr>
								<th>餐饮费用：</th>
								<td>原价 ${goodsCater.originalPrice }元/人
									现价${goodsCater.currentPrice }元/人</td>
							</tr>
							<%-- <tr>
								<th>有效期：</th>
								<td><fmt:formatDate value="${goodsCater.periodStart }"
										pattern="yyyy年MM月dd日" /> 至 <fmt:formatDate
										value="${goodsCater.periodEnd }" pattern="yyyy年MM月dd日" /></td>
							</tr>
							<tr>
								<th>备注：</th>
								<td>${goodsCater.remarks }</td>
							</tr> --%>
							<tr>
								<th>商品图片：</th>
