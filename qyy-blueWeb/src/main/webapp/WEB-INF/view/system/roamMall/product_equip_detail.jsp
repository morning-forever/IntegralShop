						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<c:forEach items="${goodsEquipList }" var="equip">
										<tr>
										<td width="20%">${equip.spec }</td>
										<td width="20%">数量：${equip.volume }<td>
										<td width="30%">原价：${equip.original_price }元<td>
										<td width="30%">现价：${equip.current_price }元<td>
										<tr>
									</c:forEach>
									</table>
								</td>
...
<script type="text/javascript">
	...
	function doBack(id){
		window.location.href="admin/roamMall/product/main?tab=3";
	}
