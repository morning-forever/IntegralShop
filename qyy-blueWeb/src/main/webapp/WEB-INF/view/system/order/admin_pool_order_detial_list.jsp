	...
	<div class="container-fluid" id="main-container">
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">拼车订单详情列表</li>
			</ul><!--.breadcrumb-->
		</div><!--#breadcrumbs-->
		<div class="table-header">拼车订单详情列表</div>
			<!-- 租车订单 -->
			<div class="tab-pane active" id="tab_1">
				<div class="row-fluid">
					...
					<table id="table" type="2" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th class='center'>
...
function doCheck(id){
	window.location.href="admin/order/cart/check_"+id+"_4";
}
...
function initList(id){
	...
	$('#'+id).DataTable( {
		...
		"ajax": {
			...
			data:{type:tableType,busId:"${poolId}"},
			type: "POST"
		}
	} );
}
