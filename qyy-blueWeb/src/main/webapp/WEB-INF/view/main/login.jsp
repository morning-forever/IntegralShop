...
<base href="<%=path%>/">
<title>
<c:if test="${session_sysset.webappName == null || session_sysset.webappName eq ''}">
	黔易游后台管理系统
</c:if>
<c:if test="${session_sysset.webappName != ''}">
	${session_sysset.webappName}
</c:if>
</title>
<meta charset="UTF-8" />
...
<body>
	<div
		...
		<div id="loginbox">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" id="loginname" value="" placeholder="请输入用户名" tabindex="1"/>
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="password" name="password" id="password" placeholder="请输入密码" value=""  tabindex="2"/>
						</div>
					</div>
				</div>
				<div style="float:right;padding-right:10%;">
					...
					<div style="float: left;">
						<input name="form-field-checkbox" id="saveid" type="checkbox"
							onclick="savePaw();" style="padding-top:0px;" tabindex="4" />
					</div>
				</div>
					...
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;" class="codediv">
							<input type="text" name="code" id="code" class="login_code"
								style="height:16px; padding-top:0px;" tabindex="3"/>
						</div>
						<div style="float: left;">
							<i><img style="height:22px;" id="codeImg" alt="点击更换" title="点击更换" src="static/login/yan.png" /></i>
						</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © Bluemobi 2100</span></font>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
				...
				$.ajax({
					...
					success: function(data){
						...
						if("success" == data.flag){
							...
							$("#loginname").focus();
						}else if("v_code_error" == data.flag){
							$("#code").tips({
								side : 1,
								msg : "验证码输入有误",
								bg : '#FF5080',
		...
		function changeCode() {
			$("#codeImg").attr("src", "admin/login?op=vcode&t=" + genTimestamp());
		}
