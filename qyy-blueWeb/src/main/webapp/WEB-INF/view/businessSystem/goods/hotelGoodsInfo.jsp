...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		...
		<ul class="nav nav-tabs" id="otherInfoTab">
		 ...
		 <input type="hidden" name="goodsHotelId" value="${goodsHotel.id }">
		...
		<div class="tab-content">
		    	...
		    	<table class="mytable-detail" >
		    			<tbody>
			    			...
			    			<tr>
			    				...
			    				<td>
			    					<input type="text" id="roomName" name="roomName" value="${goodsHotel.roomName }" tips="请输入副套餐">
			    				</td>
			    			</tr>
			    			<tr>
			    				<th>
			    				...
			    				<td>
			    					<input type="text" id="roomNumber" name="roomNumber" value="${goodsHotel.roomNumber }" tips="请输入副数量">
			    				</td>
			    			</tr>
			    			<%-- <tr>
			    				<th>
			    			...
			    			<tr>
			    				...
			    				<td>
			    					原价：<input type="text" id="originalPrice" name="originalPrice" value="${goodsHotel.originalPrice }"  tips="请输入原价">
			    				</td>
			    			</tr>
			    			<tr>
			    				<th>
			    				...
			    				<td>
									现价：<input type="text" id="currentPrice" name="currentPrice" value="${goodsHotel.currentPrice }"  tips="请输入现价">
			    				</td>
			    			</tr>
			    			<tr>
			    				<th>
			    				...
			    				<td>
			    					<div class="controls" id="isBreakfast">
			    					
										<label>
											<input name="isBreakfast" type="radio" value="0" checked /><span class="lbl"> 有</span>
										</label>
									
										<label>
											<input name="isBreakfast" type="radio" value="1" /><span class="lbl"> 没有</span>
										</label>
									</div>
			    				</td>
			    			</tr>
		    ...
		    <table>
		    	<tr>
			    	...
			    	<td>
			    		<textarea id="notice" name="notice" rows="4" cols="75" style="width: auto;"  tips="请输入入住须知">${goodsHotel.notice }</textarea>
			   		</td>
			    </tr>
		    	<tr>
			   		<th>
			    	...
			    	<td>
			    		<textarea id="usedExplain" name="usedExplain" rows="4" cols="75" style="width: auto;"  tips="请输入使用说明">${goodsHotel.usedExplain }</textarea>
			   		</td>
			    </tr>
			    <tr>
			   		<th>
...
$(document).ready(function(){
	...
	$("#isBreakfast input[value=${goodsHotel.isBreakfast}]").attr("checked","checked");
	currentPrice= isNaN(parseInt("${goodsHotel.currentPrice }"))?0:parseInt("${goodsHotel.currentPrice }");
	originalPrice=isNaN(parseInt("${goodsHotel.originalPrice }"))?0:parseInt("${goodsHotel.originalPrice }");
...
function doSubmit(){
	//需要验证的输入栏ID
	var ids="title,subtitle,roomName,roomNumber,notice,usedExplain,reminder";
	$("#detailedInfo").val(ue.getContent());
	console.info($("#detailedInfo").val());
	if(checkForm(ids)){
		$(" input[name=img]").attr("disabled","true");
		$("#form").ajaxSubmit({
			url:"merchSystem/goods/submitHotelProduct",
			type:'post',
