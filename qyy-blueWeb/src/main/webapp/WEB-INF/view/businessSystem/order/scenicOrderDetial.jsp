...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		...
		<fieldset>
			...
			<table>
				...
				<tr>
					...
					<td>订单数量</td>
					<td id="count">${order.goods_count }</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset id="couponNoFieldset">
			<legend>订购卷</legend>
			<table>
				<tr>
					<td>卷号</td>
					<td id="couponTitle">有效期</td>
				</tr>
				<tr>
					<td>${order.coupon_no }</td>
					<td id="couponState"></td>
				</tr>
			</table>
		</fieldset>
		<hr id="couponNoFieldsetHr">
...
$(document).ready(function(){
	console.info("${order.create_time}");
	//var orderTime=getTimeTxt(parseInt("${order.create_time}"));
	
	$("#couponNoFieldset").hide();
	$("#couponNoFieldsetHr").hide();
	
	var orderTime="${order.create_time}";
	var orderState="${order.order_state}";
	var couponTime="${order.coupon_time}";
	if(couponTime==""){
		var couponTime="永久有效";
	}
	...
	$("#countPrice").html(parseInt($("#unitPrice").html())*parseInt($("#count").html()));
