		...
		<div class="content clearfix">
			...
			<div class="tab-content whitebg">
				<div class="tablinks three-cols bordert1">
					<a href="pc/simple/downlineActivity?op=scenic" >景 区</a><span class="divid-line"></span><a href="pc/simple/downlineActivity?op=hotel" class="active">酒 店</a><span class="divid-line"></span><a href="pc/simple/downlineActivity?op=depth">主题深度游</a>
				</div>
