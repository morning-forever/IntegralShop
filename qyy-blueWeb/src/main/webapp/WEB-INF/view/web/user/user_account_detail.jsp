...
<div class="wrapper inner">
	...
	<div class="content_wrap pb90">
		<div class="content pt20 clearfix">
			...
			<div class="rpart account-detail">
				<div class="right-warp">
					<div class="title">
						<span>账户明细</span>
					</div>
					<p><a href="pc/user/account/detailRule">桃子规则</a></p>
					<table width="100%" cellspacing="0" cellpadding="0" >
						<tr>
							<th width="215">操作时间</th><th width="180">操作</th><th>桃子变化</th><th>桃子余额</th>
						</tr>
						<tbody id="listShow">
							<tr><td>{time}</td><td>{operDesc}</td><td>+{operScore}</td><td>{total}</td></tr>
						</tbody>
					</table>
					<!-- 分页  -->
