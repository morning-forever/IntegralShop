		...
		<div class="content pt20 clearfix">
			...
			<div class="rpart message-center">
				<ul class="tabs clearfix">
					<li><a href="pc/order/scenic">景区</a></li>
					<li class="current">酒店</li>
				</ul>
				<div class="right-warp">
					<div class="tabs-cont">
						<ul class="subtabs">
							<li class="current"><a href="pc/order/hotel">全部订单</a></li><li><a href="pc/order/hotel">待评价</a></li><li><a href="pc/order/hotel">待付款</a></li>
						</ul>
						<div class="order-cont">
							<table width="100%" border="0" class="ordertab2 mt10 f12" cellspacing="0" cellpadding="0">
								...
								<tr class="borderline tc">
									...
									<td>1</td>
									<td><p><span class="operate optcancel"><a href="pc/order/hotel/pay">待付款</a></span></p><p class="mt20">
									<span class=" operate optcancel"><a href="pc/order/hotel/payClose">取消订单</a></span></p></td>
								</tr>
								<tr><td colspan="4">
									<div class="clearfix mt10 pl10 pb10">
										<p class="dark fl">订单号：168586249624<span class="pl20">2015-05-12  12:00:00</span></p>
								...
								<tr class="borderline tc">
									...
									<td class="orange">￥<span class="f20 bold">774</span></td>
									<td>1</td>
									<td><a href="pc/order/hotel" class="dark underline">删除订单</a></td>
								</tr>
								<tr><td colspan="4">
									<div class="clearfix mt10 pl10 pb10">
										<p class="dark fl">订单号：168586249624<span class="pl20">2015-05-12  12:00:00</span></p>
								...
								<tr class="borderline tc">
									...
									<td class="orange">￥<span class="f20 bold">774</span></td>
									<td>1</td>
									<td><p class="mb20"><span class="operate optcancel"><a href="pc/order/hotel/evaluateNo">待评价</a></span></p><a href="pc/order/hotel" class="dark underline">删除订单</a></td>
								</tr>
								<tr><td colspan="4">
									<div class="clearfix mt10 pl10 pb10">
										<p class="dark fl">订单号：168586249624<span class="pl20">2015-05-12  12:00:00</span></p>
										<span class="cred fr">交易关闭</span>
									</div>
								</td></tr>
								<tr class="borderline tc">
									<td><a href="pc/mall/scenicGoodsDetialOfIntroduce"><img src="static/web/img/det1.png" width="145" height="103" class="vm"></a><span class="pl10 omission">如家酒店(苹果园地铁站店)-特别</span></td>
