...
<div class="wrapper inner">
	...
	<div class="content_wrap pb90" style="padding-top:25px;">
		<div class="content whitebg">		
			...
			<div class="pd20">
				<h4 class="orangeh4 mb20">联系人信息</h4>
					<span class="w90 f12 grey"><span class="red f12">* </span>电话</span>
					<div class="form-item inline" style="width:186px;">
						<input type="text" placeholder="自动带入（可编辑）" />
					</div>
					<p class="f12 grey9 pt10">温馨提示：景区预定后不可退款。</p>
					<div class="tr pb20"><span class="f16 mr10 grey9">订单总价</span><span class="lorange"><span class="f18">￥</span><span class="bold f30">2137</span></span></div>
					<div class="tr"><input class="text mr10" type="text" placeholder="请输入验证码后提交" /><img class="mr20 vm" src="static/web/img/code.jpg" height="32" width="96" alt=""><span class="underline pointer lorange" style="margin-right:60px;">刷新</span>
						<button  onclick="javascript:window.location='pc/simple/payment';" class="btn lorgbtn">提交订单</button>
					</div>
			</div>
