		...
		<div class="content whitebg">		
			...
			<div class="hotalunit">				
				<ul class="horizontal_ul type2">
					...
					<li>
						<span class="col1"><a href="">如家酒店(苹果园地铁站店)仅售169元起！价值247元的大床房入住1晚</a></span>
			...
			<ul class="atab clearfix">
				<li class="active"><a href="pc/mall/hotleGoodsDetialOfIntroduce">商家介绍</a></li>
				<li><a href="pc/mall/hotleGoodsDetialOfDetial">商品详情</a></li>
				<li><a href="pc/mall/hotleGoodsDetialOfComment">用户评价(<span class="f12">100</span>)</a></li>
			</ul>
			<div class="detail-content">
				...
				<div class="listitem">
					<span class="l-title"><i class="iicon i-install"></i>店内设施：</span>
					<div class="r-content"><i class="iicon i-wifi"></i>免费WIFI<i class="ml20 iicon i-cfj"></i>吹风机<span class="ml20">P 免费泊车</span></div>
				</div>
				<div class="listitem">
