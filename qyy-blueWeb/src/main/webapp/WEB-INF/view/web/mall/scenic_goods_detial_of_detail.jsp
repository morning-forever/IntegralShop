	...
	<div class="content_wrap pb90" style="padding-top:25px;">
		<div class="content whitebg">		
			...
			<ul class="atab clearfix">
				<li><a href="pc/mall/scenicGoodsDetialOfIntroduce">商家介绍</a></li>
				<li class="active"><a href="pc/mall/scenicGoodsDetialOfDetial">商品详情</a></li>
				<li><a href="pc/mall/scenicGoodsDetialOfComment">用户评价（2）</a></li>
			</ul>
			<div class="detail-content" style="padding:40px 80px;">
				<table class="table mb20" width="100%">
					...
					<tr>
						<td>使用说明</td>
						<td>1、本单无需电话预约。<br />
2、点击立即购买并支付成功后商家将发送短信至您填写的手机号，请持此短信依提示进行消费。<br />
3.6月1日-6月7日身高低于1.5m的儿童（每名购票成人限带一名身高低于1.5米的儿童）；<br />
4.70周岁以上长者（含70周岁）凭有效身份证可免票入场；<br />
5.持国家颁发的第二代《残疾证》的残疾人免票；<br />
6.盲人、智障、生活不能自理的残疾人需家人（家人需购票）陪同入园；<br />
7.生日当天可免费入园，持本人身份证到团体售票处办理。<br />
8.每个身份证及手机号每日限购5张,购买成功3小时后生效，购票本人须同时入园；<br />
9.优惠票种一个身份证只能购买一笔订单，购买一笔以上需换另一个身份证。<br />
10.学生票凭本人身份证只可以购买一笔订单，重复下单无法换票。<br />
11.夜场门票一个身份证和一个手机号码限购2张，晚20:00点停止兑换。</td>
					</tr>
					<tr>
						<td>温馨提示</td>
						<td>1.咨询电话：0411-82509155 18624445859。<br />
2.景区开放时间：09:00 -17:30，全年开放。<br />
3.其他提示： A.通过游娃娃验证设备验证；B.刷码之后不做部分退费"。<br />
取票地址：武汉海昌极地海洋世界5号、6号窗口<br />
本单包含大门票</td>
					</tr>
					<tr>
						<td>退款说明</td>
						<td>券号一旦验证即代表消费成功，不可申请退款，请您合理安排验证时间</td>
					</tr>
					<tr>
						<td>发票信息</td>
				...
				<div class="img-text">
					<img src="static/web/img/detail1.png" alt="">
					<img src="static/web/img/detail2.jpg" alt="">
				</div>
			</div>			
		</div>			
	</div>
