	...
	<div class="content_wrap pb90">
		<div class="content order-manage">
			...
			<div class="whitebg pb20">
				<div class="f18 bold borderbs1 grey9 pb20">订单状态：<span style="color:#16cc6c;">交易成功</span></div>
				...
				<div class="tc mt20 mb20">
					<!-- <button class="btn lorgbtn">待评价</button>
					<button class="btn ml20" style="background:#5d5547;">删除订单</button> -->
					<a class="btn lorgbtn" href="pc/order/hotel">待评价</a>
