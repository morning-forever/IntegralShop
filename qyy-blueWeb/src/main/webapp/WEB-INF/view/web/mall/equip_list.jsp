...
<div class="wrapper inner">
	...
	<div class="content_wrap pb90">
		<div class="content clearfix">
			<div class="breadcrumb">当前位置：<a href="">首页</a><a href="">漫游商城</a><a href="">装备</a><span>贵阳</span></div>
			<div class="whitebg mb5">
				...
				<div class="ctgallwrap">					
					...
					<div class="ctgselect_wrap">
						...
						<a href="#" class="ctgvalue">全部</a><a href="#" class="ctgvalue">帐篷</a><a href="#" class="ctgvalue active">帐篷</a><a href="#" class="ctgvalue">帐篷</a><a href="#" class="ctgvalue">帐篷</a>
					</div>
				...
				<!-- 已筛选结果 -->
				<div class="ctgresult">
					<div class="f12 grey9 pb10"><span class="f14 orange">16</span> 家满足条件</div>
					<div class="itemwrap"><span class="item">帐篷<i class="iicon i-del"></i></span><span class="varrow">&gt;</span><span class="item">都均市<i class="iicon i-del"></i></span><button class="btn formbtn orgbtn">清空条件</button></div>
				</div>
			</div>
			...
			<div class="whitebg">
				...
				<div class="listwrap type3 type3_3">
					<ul class="list_ul clearfix">
						<li>
							<a href="pc/mall/equipGoodsDetialOfIntroduce"><img src="static/web/img/eqm1.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥98</span>&nbsp;&nbsp;<span class="orderprice">￥120</span></div>							
							</div>							
						</li>
						<li>
							<a href=""><img src="static/web/img/eqm2.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥98</span>&nbsp;&nbsp;<span class="orderprice">￥120</span></div>							
							</div>							
						...
						<li>
							<a href=""><img src="static/web/img/eqm3.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥328</span>&nbsp;&nbsp;<span class="orderprice">￥420</span></div>							
							</div>							
						</li>
						<li>
							<a href=""><img src="static/web/img/eqm4.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥198</span>&nbsp;&nbsp;<span class="orderprice">￥220</span></div>							
							</div>							
						</li>
						<li>
							<a href=""><img src="static/web/img/eqm5.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥98</span>&nbsp;&nbsp;<span class="orderprice">￥120</span></div>							
							</div>							
						...
						<li>
							<a href=""><img src="static/web/img/eqm6.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥98</span>&nbsp;&nbsp;<span class="orderprice">￥120</span></div>							
							</div>							
						...
						<li>
							<a href=""><img src="static/web/img/eqm7.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥328</span>&nbsp;&nbsp;<span class="orderprice">￥420</span></div>							
							</div>							
						...
						<li>
							<a href=""><img src="static/web/img/eqm8.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥198</span>&nbsp;&nbsp;<span class="orderprice">￥220</span></div>							
							</div>							
						...
						<li>
							<a href=""><img src="static/web/img/eqm1.jpg" width="100%" alt=""></a>
							<div class="incont">
								<h4><a href="">公狼帐篷户外</a></h4>
								<div class="rel"><span class="lorange">￥98</span>&nbsp;&nbsp;<span class="orderprice">￥120</span></div>							
							</div>							
