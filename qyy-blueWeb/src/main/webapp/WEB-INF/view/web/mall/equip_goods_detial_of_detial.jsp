	...
	<div class="content_wrap pb90" style="padding-top:25px;">
		<div class="content whitebg">		
			...
			<ul class="atab clearfix">
				<li><a href="pc/mall/equipGoodsDetialOfIntroduce">商家介绍</a></li>
				<li class="active"><a href="pc/mall/equipGoodsDetialOfDetial">商品详情</a></li>
			</ul>
			<div class="detail-content" style="padding:40px 80px;">
				<table class="table mb20" width="100%">
					...
					<tr>
						<td>温馨提示</td>
						<td>2015.6.4 至 2016.7.3（周末、法定节假日通用），押金100元</td>
					</tr>
					<tr>
						<td>温馨提示</td>
						<td>公园休闲露营防风防暴雨3-4人三季帐自动帐篷零动</td>
					</tr>
				</table>
				<div class="img-text">
