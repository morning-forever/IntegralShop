...
@Controller(value = "RegisterCountController")
@RequestMapping("admin/register_count")
public class RegisterCountController extends BaseController{
	...
	public ModelAndView index(){
		...
		mav.setViewName("system/count/register_count");
		return mav;
	}
	...
	public PageData list(){
		...
		try {
			...
			List<Map<String, Object>> list=userCountService.findRegisterList(pd);
			pd.put("data", list);
		} catch (Exception e) {
			e.printStackTrace();
		}
