package com.bm.common.util.date;
...
public class TimeHelper {
    ...
    /**
     * 获取相隔多少天的日期
     * @param 把日期往后增加一天.整数往后推,负数往前移动
     * @return
     */
    public static Date getDaysOfTheDate(Integer param){
...
//		sql=sb.toString().replaceFirst("union", "");
		...
		System.out.println(TimeHelper.formatDate(TimeHelper.getDaysOfTheDate(1),"yyyy-MM-dd HH:mm:ss"));
